...
export type TopPlayersCataloguesQuery = { __typename?: 'Query', playerRounds: Array<{ __typename?: 'PlayerRound', score: number, roundId: number, playerId: number, player?: { __typename?: 'Player', id: string, name: string, image: string, lastName?: string | null, positionId: number, playerTypeId: number, clubId: number, club: { __typename?: 'Club', id: string, name: string, image: string, clubCategoryId: number } } | null } | null>, clubCategories: Array<{ __typename?: 'ClubCategory', id: string, name: string, image: string } | null> };
